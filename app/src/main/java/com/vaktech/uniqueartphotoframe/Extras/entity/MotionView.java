package com.vaktech.uniqueartphotoframe.Extras.entity;
...
import com.vaktech.uniqueartphotoframe.Extras.Multitouch.MoveGestureDetector;
import com.vaktech.uniqueartphotoframe.Extras.Multitouch.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    private void initEntityBorder(@NonNull MotionEntity entity ) {
        ...
        borderPaint.setColor(ContextCompat.getColor(getContext(), R.color.transparent));
